...
// const some_delays = [4000, 5000, 2000, 3000];
const SERVER_DELAYS = [ SERVER_DELAY ];
let index = 0;
...
server.listen(1337, () => {
  console.log(`Server listening on port 1337 with server delay: ${SERVER_DELAYS[index] / 1000}s`);
});
